...
class OuraMain extends LitElement {
        ...
        return html`
            ...
            <div class="date-selectors">
                <sl-input
                        ...
                        value="${this.fromDate}"
                        id="start-date"></sl-input>
                <sl-input
                        label="End date" placeholder="Date" type="date"
                        value="${this.toDate}"
                        id="end-date"></sl-input>
                <sl-button @click=${() => {
                    this.fromDate = this.shadowRoot.getElementById('start-date').value;
                    this.toDate = this.shadowRoot.getElementById('end-date').value;
                }}>Apply</sl-button>
            </div>
    ...
    async _fetchSleepData() {
        ...
        try {
            ...
            const [sleepData, activityData, spo2Data, stressData, vo2Data, workoutData, hrData] = await Promise.all(fetches);
