...
class OuraSleepGraph extends LitElement {
    ...
    constructor() {
        ...
        this._detailGraphs = [
            {id: 0, focus: 'average_hrv', agg: 'mean', k: 7, curve: 'step', plotType: 'line', interval: 'month', yZero: true},
        ];
        this._nextId = 1;
    ...
    _updateDetailGraph(id, params) {
        this._detailGraphs = this._detailGraphs.map(g =>
            g.id === id ? {...g, focus: params.focus, agg: params.agg, k: params.k, curve: params.curve, plotType: params.plotType, interval: params.interval, yZero: params.yZero} : g
        );
    }
                ...
                <div class="graph">
                    ${Plot.plot({
                        ...
                        y: {
                            ...
                            grid: true,
                            ...(graph.yZero ? {} : {domain: [yMin - yPad, yMax + yPad]}),
                        },
                        marks: [
