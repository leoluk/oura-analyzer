...
const sleepAttributes = [
    ...
    {"type": "separator", "section": "Body"},
    {"name": "weight", "label": "Weight", "unit": "kg"},
    {"name": "fat_mass", "label": "Fat mass", "unit": "kg"},
    {"name": "bone_mass", "label": "Bone mass", "unit": "kg"},
    {"name": "muscle_mass", "label": "Muscle mass", "unit": "kg"},
    {"name": "hydration", "label": "Hydration", "unit": "kg"},
]
...
class OuraSleepGraph extends LitElement {
    ...
    constructor() {
        ...
        this._detailGraphs = [
            {id: 0, focus: 'average_hrv', agg: 'mean', k: 7, loessSpan: 30, curve: 'step', plotType: 'line', interval: 'month', yZero: true, showTrend: false},
        ];
        this._nextId = 1;
    ...
    _updateDetailGraph(id, params) {
        this._detailGraphs = this._detailGraphs.map(g =>
            g.id === id ? {...g, focus: params.focus, agg: params.agg, k: params.k, loessSpan: params.loessSpan, curve: params.curve, plotType: params.plotType, interval: params.interval, yZero: params.yZero, showTrend: params.showTrend} : g
        );
    }
            ...
            <div class="graph" @input=${e => console.log(this.selected = e.target.value?.date)}>
                ${Plot.plot({
                    ...
                    marks: [
                        ...
                        ...markerMarks(this._markers, this.sleepData),
                    ]
                })}
            </div>
        `;
            ...
            <div class="graph">
                ${Plot.plot({
                    ...
                    marks: [
                        ...
                        ...markerMarks(this._markers, data),
                    ]
                })}
            </div>
        `;
